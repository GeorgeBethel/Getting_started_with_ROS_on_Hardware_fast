...
set(MSG_I_FLAGS "-Iled_control:/home/george/Getting_started_with_ROS_on_Hardware_fast/src/led_control/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/george/Getting_started_with_ROS_on_Hardware_fast/src/led_control/msg/led.msg" NAME_WE)
add_custom_target(_led_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "led_control" "/home/george/Getting_started_with_ROS_on_Hardware_fast/src/led_control/msg/led.msg" ""
)
...
_generate_msg_cpp(led_control
  "/home/george/Getting_started_with_ROS_on_Hardware_fast/src/led_control/msg/led.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/led_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/led_control\")")
  # install generated code
  install(
